...
class Session extends resource_1.APIResource {
    ...
    proxyExecute(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/api/v3/tool_router/session/${sessionID}/proxy_execute`, {
            body,
            ...options,
        });
    }
    ...
    search(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/api/v3/tool_router/session/${sessionID}/search`, { body, ...options });
    }
    /**
    ...
    tools(sessionID, query, options) {
        return this._client.get((0, path_1.path) `/api/v3/tool_router/session/${sessionID}/tools`, options);
    }
}
